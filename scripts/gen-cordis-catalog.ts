...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExternalToolId: 'Host-connected external-tool id is owned by packages/preset/agent-presets/README.md',
  ExternalToolProjector: 'Host projection callback is owned by packages/preset/agent-presets/README.md',
  ExternalToolsPresetState: 'Host external-tools state is owned by packages/preset/agent-presets/README.md',
