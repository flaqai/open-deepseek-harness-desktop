...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExternalToolId: 'external tool identity is owned by packages/preset/agent-presets/README.md',
  ExternalToolProjector: 'external tool projection is owned by packages/preset/agent-presets/README.md',
  ExternalToolsPresetState: 'external tool state is owned by packages/preset/agent-presets/README.md',
