...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsNavigation: 'client-side process-local settings navigation service — packages/client/ui-settings/README.md owns the API',
  customInstructions: 'client-side trusted custom-prompt editor — packages/context/custom-instructions/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExternalToolId: 'external tool identity is owned by packages/preset/agent-preset-registry/README.md',
  ExternalToolProjector: 'external tool projection is owned by packages/preset/agent-preset-registry/README.md',
  ExternalToolsPresetState: 'external tool state is owned by packages/preset/agent-preset-registry/README.md',
  ExternalToolsState: 'external tool state is owned by packages/preset/agent-preset-registry/README.md',
