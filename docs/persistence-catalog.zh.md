...
来源：[`packages/preset/agent-preset-registry/src/session.ts:42`](../packages/preset/agent-preset-registry/src/session.ts)
...
来源：[`packages/preset/agent-preset-registry/src/session.ts:48`](../packages/preset/agent-preset-registry/src/session.ts)
...
[`HookDialect`](#persistence-type-sha256-a6b41f5bede8094d7bf635be5d69b1bd7a25e006ca9cf9415bceb9322f1a7feb) 的数组。
...
|---|---|---|
| `step` | 必需 | `number` |
| `tools` | 必需 | [`HookDialect[]`](#persistence-type-sha256-7c6909e92a2d720b6d5679641acf2c2cfdf02df82554d8db23cbfccb0eb58145) |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ step, tools, turn }`](#persistence-type-sha256-bd7d37ddd92bc17b7b7f61eca8c5d54ed59f43e29287bbc449ab857ddcc9d351) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"external-tools/resolved"` |
