...
- `refs`: `Volatile` (`@deepseek-ai/cordis`)
- `source`: [`packages/preset/agent-preset-registry/src/preset.ts:14`](../packages/preset/agent-preset-registry/src/preset.ts)
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-custom-instructions -->
<a id="deepseek-aidsh-custom-instructions"></a>

## `@deepseek-ai/dsh-custom-instructions`

- `inject`: `settings` · `systemPrompt` · `workspaceRegistry`
- `refs`: `Volatile` (`@deepseek-ai/cordis`)
- `source`: [`packages/context/custom-instructions/src/index.ts:47`](../packages/context/custom-instructions/src/index.ts)
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-custom-instructions -->
...
- `inject`: `loader` · `subprocess`
- `source`: [`packages/host/plugin-inventory/src/index.ts:154`](../packages/host/plugin-inventory/src/index.ts)
...
<!-- BEGIN GENERATED config-catalog:@deepseek-ai/dsh-host-workspace-runtime -->
...
```
<!-- END GENERATED config-catalog:@deepseek-ai/dsh-host-workspace-runtime -->
...
| `@deepseek-ai/dsh-client-ui-brand-community-desktop` | — | [`packages/client/ui-brand-community-desktop/src/index.ts`](../packages/client/ui-brand-community-desktop/src/index.ts) |
...
| `@deepseek-ai/dsh-nas-protocol` | — | [`packages/nas/nas-protocol/src/index.ts`](../packages/nas/nas-protocol/src/index.ts) |
