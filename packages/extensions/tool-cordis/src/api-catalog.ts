...
export const SERVICE_API: readonly ServiceApiEntry[] = [
    ...
    methods: [
      {
        ...
        description: 'Register the one Desktop Host implementation that mounts connected product tools.',
        parameters: [{ name: 'projector', description: 'Host-owned mount function for an idle Agent and enabled tool.' }],
        returns: 'Disposer that removes this projector and reconciles idle Agents.',
      },
      {
        signature: 'externalToolsState(): Promise<ExternalToolsState>',
      ...
      {
        signature: 'async setExternalTool(tool: ExternalToolId, enabled: boolean): Promise<ExternalToolsState>',
        description: 'Persist one connection in the current Profile without interrupting running turns.',
        parameters: [{ name: 'tool', description: 'The supported external tool identity.' }, { name: 'enabled', description: 'Whether the tool should be projected into eligible Agents.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'readonly projectPatches?: (patches: readonly PatchOptions[]) => PatchOptions[]',
        description: 'Product-owned projection reapplied to every startup and HMR composition.',
        parameters: [],
      },
    ],
  },
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'ExternalToolsState',
    declaration: 'export interface ExternalToolsState {\n    readonly scope: \'complete-presets\';\n    readonly codex: boolean;\n    readonly claudeCode: boolean;\n}',
  },
  {
