...
export class WorkspaceRegistry extends Service {
  ...
  /**
   * Remove one session from the durable archive set without changing its
   * Workspace accounting or Session log. An active id resolves without writing.
   * @param sessionId - Session to reveal on grouping surfaces.
   * @returns resolution after durability.
   */
