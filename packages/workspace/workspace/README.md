...
- **Archiving is reversible but not deletion** — a hidden Session keeps its history and Workspace position; removing its id from the durable archive set reveals the same Session again.
