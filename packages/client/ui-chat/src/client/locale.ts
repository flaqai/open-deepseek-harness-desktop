...
export const zh = {
  ...
  'localImage.checking': '正在准备图片预览…',
  'localImage.unavailable': '{count} 张图片暂不可预览，点击重试',
  'localImage.open': '打开原图',
  'localImage.reveal': '在文件夹中显示',
...
export const en = {
  ...
  'localImage.checking': 'Preparing image preview…',
  'localImage.unavailable': '{count} image(s) can’t be previewed yet. Retry',
  'localImage.open': 'Open original',
  'localImage.reveal': 'Show in folder',
