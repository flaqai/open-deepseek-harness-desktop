...
export const zh = {
  ...
  closeDetails: '关闭字体详情',
  unavailable: 'Office 预览不可用。请在桌面设置的“工作运行时”中安装并启用官方 Office 引擎。',
...
export const en = {
  ...
  unavailable: 'Office previews are unavailable. Install and enable the official Office engine under Workspace runtimes in Desktop settings.',
