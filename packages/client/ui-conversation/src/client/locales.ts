...
export const zh = {
  ...
  'hero.headline': '构建你的下一个想法',
  'hero.preview': '预览版',
  'hero.chooseWorkspace': '选择工作区',
  'session.hierarchy': '会话层级',
  'session.actions.copy': '复制已加载对话',
  'session.actions.more': '更多会话操作',
  'session.actions.clear': '清空并新建会话',
  'session.actions.remove': '删除会话',
  'session.actions.cancel': '取消',
  'session.actions.working': '处理中…',
  'session.actions.speaker.user': '用户',
  'session.actions.speaker.assistant': 'DeepSeek',
  'session.actions.clear.title': '清空当前会话？',
  'session.actions.clear.description': '当前会话会从列表中移除，执行日志仍保留在本地存储中；随后将在同一工作区打开一个全新会话。',
  'session.actions.clear.description.noWorkspace': '当前会话会从列表中移除，执行日志仍保留在本地存储中；随后返回新会话界面。',
  'session.actions.clear.confirm': '清空并新建',
  'session.actions.remove.title': '删除当前会话？',
  'session.actions.remove.description': '会话会从客户端列表中移除。为了保持执行记录可审计，底层日志不会被物理删除，当前界面也不提供恢复入口。',
  'session.actions.remove.confirm': '删除会话',
  'details.title': '详情',
  'details.close': '关闭详情',
...
export const en = {
  ...
  'session.actions.copy': 'Copy loaded conversation',
  'session.actions.more': 'More session actions',
  'session.actions.clear': 'Clear and start new',
  'session.actions.remove': 'Delete session',
  'session.actions.cancel': 'Cancel',
  'session.actions.working': 'Working…',
  'session.actions.speaker.user': 'User',
  'session.actions.speaker.assistant': 'DeepSeek',
  'session.actions.clear.title': 'Clear this session?',
  'session.actions.clear.description': 'This session will leave the list while its execution log remains in local storage. A new session will then open in the same workspace.',
  'session.actions.clear.description.noWorkspace': 'This session will leave the list while its execution log remains in local storage. The app will then return to New Session.',
  'session.actions.clear.confirm': 'Clear and start new',
  'session.actions.remove.title': 'Delete this session?',
  'session.actions.remove.description': 'The session will leave the client list. Its underlying log is not physically deleted so execution remains auditable; this interface currently has no restore action.',
  'session.actions.remove.confirm': 'Delete session',
