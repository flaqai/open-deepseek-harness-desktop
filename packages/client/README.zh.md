...
| [`ui-desktop-shell/`](ui-desktop-shell/README.zh.md) | 添加 Electron 专属桌面偏好与 Release 发现功能。 |
| [`ui-settings-models/`](ui-settings-models/README.zh.md) | 提供模型提供方配置与 DeepSeek 配置引导。 |
| [`ui-settings-plugin-inventory/`](ui-settings-plugin-inventory/README.zh.md) | 向“插件”设置贡献 Host Loader 清单与受保护的插件发现／安装界面。 |
