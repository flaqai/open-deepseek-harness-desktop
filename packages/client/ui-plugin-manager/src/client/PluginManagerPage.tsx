...
export type PluginManagerPageProps =
  ...
  & PropsRenderSlots<
    | 'plugins.item' | 'plugins.bundle.action' | 'plugins.bundle.config' | 'plugins.row.config' | 'plugins.bundle.activation'
