...
export const zh = {
  ...
  builtinAgentTeamDescription: '启用团队协作和团队工具；这个能力层本身不显示界面。',
  builtinAgentTeamWebTitle: '智能体团队界面',
  builtinAgentTeamWebDescription: '在桌面客户端或浏览器的对话标题栏查看团队成员、任务看板和成员会话；开启时会同时启用团队能力。',
...
export const en = {
  ...
  builtinAgentTeamDescription: 'Enable team collaboration and team tools; this capability layer has no interface of its own.',
  builtinAgentTeamWebTitle: 'Agent Teams UI',
  builtinAgentTeamWebDescription: 'View members, the task board, and teammate sessions in the conversation header on Desktop or the Web; switching it on also enables the Team capability.',
