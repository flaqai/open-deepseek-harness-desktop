...
export const en = {
  ...
  'setup.progress': '{count} / 2 completed',
  'setup.success': 'Configuration complete',
  'setup.successDescription': 'Your model and messaging bot are ready.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  'setup.skipped': '已跳过',
  'setup.completed': '已完成',
  'setup.progress': '已完成 {count} / 2',
  'setup.success': '配置成功',
  'setup.successDescription': '模型与消息机器人均已准备就绪。',
  'setup.ready': '已准备就绪',
