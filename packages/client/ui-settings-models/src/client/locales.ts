...
export const en = {
  ...
  'setup.codex.description': 'Enable the preinstalled official Codex provider for complete-mode sessions.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  'setup.codex.description': '为完整模式会话启用安装包预置的官方 Codex Provider。',
  'setup.configure': '配置',
  'setup.connect': '连接',
