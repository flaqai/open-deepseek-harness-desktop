...
export const zh = {
  ...
  'archive.nav': '已归档会话',
  'archive.title': '已归档会话',
  'archive.description': '查看隐藏的历史会话，并将它们恢复到原来的工作区位置。会话内容不会在归档或恢复时改变。',
  'archive.restoreAll': '全部取消归档',
  'archive.restore': '取消归档',
  'archive.restoring': '正在恢复…',
  'archive.restoreFailed': '无法恢复会话，请检查连接后重试。',
  'archive.search.aria': '搜索已归档会话',
  'archive.search.placeholder': '搜索已归档会话…',
  'archive.workspaceFilter': '按工作区筛选',
  'archive.allWorkspaces': '所有工作区',
  'archive.loading': '正在加载已归档会话…',
  'archive.empty.title': '没有已归档会话',
  'archive.empty.description': '归档的会话会显示在这里。',
  'archive.noMatches.title': '没有匹配的会话',
  'archive.noMatches.description': '请尝试其他搜索词或工作区。',
  'archive.dateUnknown': '更新时间未知',
...
export const en = {
  ...
  'archive.nav': 'Archived sessions',
  'archive.title': 'Archived sessions',
  'archive.description': 'Review hidden session history and restore sessions to their original workspace positions. Archiving and restoring do not change session content.',
  'archive.restoreAll': 'Unarchive all',
  'archive.restore': 'Unarchive',
  'archive.restoring': 'Restoring…',
  'archive.restoreFailed': 'The session could not be restored. Check the connection and try again.',
  'archive.search.aria': 'Search archived sessions',
  'archive.search.placeholder': 'Search archived sessions…',
  'archive.workspaceFilter': 'Filter by workspace',
  'archive.allWorkspaces': 'All workspaces',
  'archive.loading': 'Loading archived sessions…',
  'archive.empty.title': 'No archived sessions',
  'archive.empty.description': 'Sessions you archive will appear here.',
  'archive.noMatches.title': 'No matching sessions',
  'archive.noMatches.description': 'Try another search or workspace.',
  'archive.dateUnknown': 'Update time unavailable',
