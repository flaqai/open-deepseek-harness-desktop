...
function PanelChrome({ sessionId, fullscreen, autoFullscreen, actions, t, shortcuts, toggleFullscreen }: Pick<PanelProps, 'sessionId' | 'actions' | 't' | 'fullscreen' | 'autoFullscreen' | 'shortcuts' | 'toggleFullscreen'>): ReactNode {
  ...
  return (
    <>
      {!autoFullscreen && <Tooltip label={modeLabel} shortcutKeys={mode?.keys} side="bottom" delayMs={500}>
        <button
          type="button"
    ...
    >
      <div className={css.panelBody}>
        <DockLayout
          ...
          chrome={<PanelChrome
            sessionId={sessionId} fullscreen={fullscreen} autoFullscreen={panel.autoFullscreen} actions={actions} t={t}
