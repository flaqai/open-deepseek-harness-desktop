...
LangString AppProcessesRunning 2052 "检测到以下由 Open DeepSeek Harness Desktop 安装目录启动的进程。继续后，安装程序会先请求它们正常退出，随后关闭仍在运行的进程。"
LangString AppProcessesRunning 1033 "The following processes were started from the Open DeepSeek Harness Desktop installation. Continuing asks them to exit and then closes any that remain."
...
LangString AppProcessInspectionFailed 2052 "安装程序无法安全检查 Open DeepSeek Harness Desktop 进程。为避免损坏安装，本次操作已停止。"
LangString AppProcessInspectionFailed 1033 "The installer could not safely inspect Open DeepSeek Harness Desktop processes. Installation has stopped to avoid corrupting the application."
