...
const HARNESS_INVOCATION_ENVIRONMENT = [
  ...
  'DSH_DESKTOP_MUTATION_OWNER_PID',
  'DSH_DIAGNOSTIC_LAB',
  'DSH_PLUGIN_SNAPSHOT_LEASE_TOKEN',
  'DSH_PLUGIN_SNAPSHOT_LEASE_OWNER_PID',
  'DSH_PLUGIN_SNAPSHOT_BATCH',
  'DSH_PLUGIN_TRANSACTION_ORIGIN',
  'DSH_PROFILE_DIAGNOSTIC_MODE_ON_FAILURE',
  'DSH_DESKTOP_PERSISTENT_SERVICES',
  'DSH_DESKTOP_PERSISTENT_PROFILE',
  'HTTP_PROXY',
  'HTTPS_PROXY',
  'ALL_PROXY',
  'NO_PROXY',
