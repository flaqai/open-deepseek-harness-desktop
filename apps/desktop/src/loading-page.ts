...
const chineseCopy: RecoveryCopy = {
  ...
  stages: { 'preparing-desktop': '正在准备桌面环境', 'preparing-runtime': '准备应用组件', 'checking-profile': '检查配置', 'verifying-plugin': '正在校验插件', 'extracting-plugin': '正在解压插件', 'configuring-plugin': '准备预设插件', 'starting-harness': '启动客户端', 'restarting-harness': '正在重新启动 Harness', 'waiting-background-tasks': '正在等待或取消后台修改任务', 'stopping-harness': '正在请求 Harness 和插件正常停止', 'reclaiming-processes': '正在回收受管进程树', 'checking-shutdown': '正在确认配置目录已解除占用', ready: '启动完成' },
