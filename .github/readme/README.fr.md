...
> [!IMPORTANT]
>
> **[v0.1.5-rc.2.3 est disponible](https://github.com/flaqai/open-deepseek-harness-desktop/releases/tag/odsh-v0.1.5-rc.2.3).** Basée sur DeepSeek Harness `0.1.5-rc.2`, cette version améliore l’affichage sur téléphone et dans les petites fenêtres, la recherche de modèles et les longues réponses, l’import des configurations communautaires, la mise à niveau et la récupération des plugins intégrés, la confirmation du redémarrage du marché et les journaux de diagnostic persistants.
>
...
L’installateur contient huit presets de démarrage sous forme d’archives locales dont l’intégrité est vérifiée : Plugin Marketplace, dsh-im, Better Sidebar, dsh-pocket, `@ychris12138/dsh-usage-stats`, `dsh-smooth-stream`, `dsh-mermaid` et `dsh-whale-widget`. Usage Stats ajoute le suivi des tokens, les comptes fournisseurs, l’estimation des coûts de session, les budgets et les exports ; Smooth Stream apporte un rendu progressif et un défilement fluides pour le Markdown, les blocs de code, les tableaux et les résultats d’outils. `dsh-font` est fourni uniquement comme échantillon pour les exercices de diagnostic. Lorsqu’un utilisateur désinstalle un preset, le client ne le réinstalle pas automatiquement.

#### Remerciements aux plugins prédéfinis

Merci aux auteurs et mainteneurs de [`dshmarket`](https://github.com/dsh-market/dsh-market), [`@xmanrui/dsh-im`](https://github.com/xmanrui/dsh-im), [`dsh-better-sidebar`](https://github.com/omdsh-dev/DSH-better-sidebar), [`dsh-pocket`](https://github.com/shaobeichen/dsh-pocket), [`@ychris12138/dsh-usage-stats`](https://github.com/Ychris12138/dsh-usage-stats), [`dsh-smooth-stream`](https://github.com/Laplace-bit/dsh-smooth-stream), [`dsh-mermaid`](https://github.com/MrmoLabs/dsh-mermaid) et [`dsh-whale-widget`](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget). Ce projet assure l’intégration au bureau et la distribution d’archives dont l’intégrité est vérifiée ; les droits d’auteur, licences et maintenance restent propres à chaque projet de plugin.
...
Téléchargez le paquet adapté depuis [GitHub Releases](https://github.com/flaqai/open-deepseek-harness-desktop/releases/tag/odsh-v0.1.5-rc.2.3).
